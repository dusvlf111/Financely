...
- [x] 3.0 클라이언트 UI/UX 구현
	...
	- 테스트:
		...
		- [x] 3.0.4 DB 미연결 시 퀘스트 Mock 데이터 fallback
			...
			- [x] 3.0.9 퀘스트 진행 RPC 오류 수정
				- [x] 3.0.9.1 테스트 코드 작성 — `tests/auth.trackQuestProgress.test.tsx`
				- [x] 3.0.9.2 테스트 실행 및 검증 — `npm run test -- auth.trackQuestProgress.test.tsx`
				- [x] 3.0.9.3 오류 수정 (필요 시)
			- [ ] 3.0.10 문제 성공 메시지 띄어쓰기 보정
				...
				- [x] 3.0.11 모바일 뷰 타이포그래피 보정
					- [x] 3.0.11.1 테스트 코드 작성 — `tests/quest.page.test.tsx`
					- [x] 3.0.11.2 테스트 실행 및 검증 — `npm run test -- quest.page.test.tsx`
					- [x] 3.0.11.3 오류 수정 (필요 시)
				- [x] 3.0.12 보상 문구 레이아웃 보정
					- [x] 3.0.12.1 테스트 코드 작성 — `tests/problem.success.test.tsx`
					- [x] 3.0.12.2 테스트 실행 및 검증 — `npm run test -- problem.success.test.tsx`
					- [x] 3.0.12.3 오류 수정 (필요 시)
				- [x] 3.0.13 퀘스트 로드 완료 애니메이션
					- [x] 3.0.13.1 테스트 코드 작성 — `tests/quest.page.test.tsx`
					- [x] 3.0.13.2 테스트 실행 및 검증 — `npm run test -- quest.page.test.tsx`
					- [x] 3.0.13.3 오류 수정 (필요 시)
				- [x] 3.0.14 퀘스트 재로딩 시 카드 깜박임 제거
					- [x] 3.0.14.1 테스트 코드 작성 — `tests/quest.page.test.tsx`
					- [x] 3.0.14.2 테스트 실행 및 검증 — `npm run test -- quest.page.test.tsx`
					- [x] 3.0.14.3 오류 수정 (필요 시)
	- [x] 3.0.15 네비게이션 진입 시 퀘스트 카드 깜박임 제거
		- [x] 3.0.15.1 테스트 코드 작성 — `tests/quest.page.test.tsx`
		- [x] 3.0.15.2 테스트 실행 및 검증 — `npm run test -- quest.page.test.tsx`
		- [x] 3.0.15.3 오류 수정 (필요 시)
	- [x] 3.0.16 캐시 사용 시 카드 애니메이션 비활성화
		- [x] 3.0.16.1 테스트 코드 작성 — `tests/quest.page.test.tsx`
		- [x] 3.0.16.2 테스트 실행 및 검증 — `npm run test -- quest.page.test.tsx`
		- [x] 3.0.16.3 오류 수정 (필요 시)
	- [x] 3.0.17 퀘스트 페이지 컴포넌트 분리 및 리팩터링
		- [x] 3.0.17.1 테스트 코드 작성 — `tests/quest.page.test.tsx`
		- [x] 3.0.17.2 테스트 실행 및 검증 — `npm run test -- quest.page.test.tsx`
		- [x] 3.0.17.3 오류 수정 (필요 시)
