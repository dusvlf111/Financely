  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-primary-600 via-primary-500 to-primary-400 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-white/5 rounded-full blur-3xl animate__animated animate__pulse animate__infinite animate__slower"
      ...
      <div className="relative text-center z-10">
        ...
        <div className="mt-8 animate__animated animate__fadeIn animate__delay-2s">
          <div className="flex justify-center gap-2">
            <div
              className="w-2 h-2 bg-white rounded-full animate__animated animate__bounce animate__infinite"
