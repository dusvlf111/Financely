...
export const FALLBACK_USER_MESSAGE = '로그인이 필요합니다.'
export const EMPTY_MESSAGE = '등록된 퀘스트가 없습니다.'

export const QUEST_TYPE_ORDER: QuestType[] = ['weekly', 'daily', 'monthly', 'premium', 'event']

export const QUEST_TYPE_LABEL: Record<QuestType, { title: string; emptyLabel: string }> = {
...
export const OTHER_TYPE_LABEL = { title: '기타 퀘스트', emptyLabel: '기타 퀘스트가 없습니다.' }
