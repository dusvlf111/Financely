...
export default function LevelWorksheet({ level }: LevelWorksheetProps) {
  ...
  if (!worksheet) {
    return (
      <div className="card-md-animated animate__animated animate__fadeInUp p-6">
  ...
  return (
    <div className="card-md-animated animate__animated animate__fadeInUp stagger-3 p-6">
      {/* 헤더 */}
      <div className="mb-6">
